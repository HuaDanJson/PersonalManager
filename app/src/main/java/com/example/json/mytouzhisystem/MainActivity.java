...
public class MainActivity extends BaseActivity {
    ...
    @BindView(R.id.btnMainActivityKnowledge)
    Button btnMainActivityKnowledge;
    @BindView(R.id.btnMainActivityKind)
    Button btnMainActivityKind;
    @BindView(R.id.btnMainActivityStatistics)
    Button btnMainActivityStatistics;
    @BindView(R.id.btnMainActivityAnalysis)
    Button btnMainActivityAnalysis;
    ...
    //设置点击事件
    @OnClick({R.id.btnMainActivityKnowledge, R.id.btnMainActivityKind, R.id.btnMainActivityStatistics,
            R.id.btnMainActivityAnalysis, R.id.btnMainActivityChangeBg})
    public void onClick(View view) {
        switch (view.getId()) {
            //处理点击投资知识库点击事件
            case R.id.btnMainActivityKnowledge:
                toActivity(KnowledgeActivity.class);
                break;
            //处理点击类别点击事件
            case  R.id.btnMainActivityKind:
                ...
                break;
            //处理点击总数据统计点击事件
            case R.id.btnMainActivityStatistics:
               toActivity(StatisticsActivity.class);
                break;
            //处理点击总数据分析事件
            case  R.id.btnMainActivityAnalysis:
                toActivity(AnalysisActivity.class);
                break;
            //处理点击更换背景点击事件
